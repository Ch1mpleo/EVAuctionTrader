...
namespace EVAuctionTrader.Presentation.Architecture
{
    public static class IocContainer
    {
        ...
        private static IServiceCollection SetupDbContext(this IServiceCollection services)
        {
            ...
            services.AddDbContext<EVAuctionTraderDbContext>(options =>
                options.UseNpgsql(connectionString,
                    sql => sql.MigrationsAssembly(typeof(EVAuctionTraderDbContext).Assembly.FullName)
                )
            );
